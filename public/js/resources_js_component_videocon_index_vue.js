        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this.axios.post('/api/video/create', _this.meeting).then(function (response) {
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "card-header card-header-primary" }, [
      _c("h4", { staticClass: "card-title" }, [_vm._v("Vide Con")]),
      _vm._v(" "),
      _c("p", { staticClass: "card-category" }, [_vm._v("Create video con")])
    ])
  }
]

...
/* harmony import */ var _classes_cardTitle_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../classes/cardTitle.vue */ "./resources/js/component/classes/cardTitle.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    fetchCredential: function fetchCredential() {
      var _this2 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this2.axios.get(baseUrl + "/api/video/tokens/credentials").then(function (res) {
                  _this2.api_key = res.data.api_key;
                  _this2.api_secret = res.data.api_secret;
                })["catch"](function (err) {});
    ...
    createMeeting: function createMeeting() {
      ...
      axios.post(baseUrl + "/api/video/create", this.meeting).then(function (response) {
        ...
        _this3.fetchMeetings();

        $("#exampleModal").modal("hide");
        _this3.is_form_create ? success_add() : success_update();
    ...
    editMeeting: function editMeeting(id) {
      ...
      axios.get(baseUrl + "/api/video/".concat(id)).then(function (response) {
        _this5.meeting = response.data; // this.meeting.scheduled_at = new Date(response.data.scheduled_at).toISOString();
    ...
    fetchAttendee: function fetchAttendee(id) {
      ...
      this.attendees = [];
      axios.get(baseUrl + "/api/video/attendee/".concat(id)).then(function (response) {
        console.log(response);
        _this6.attendees = response.data;
      })["catch"](function (error) {});
    }
  },
  created: function created() {
  ...
  components: {
    CardTitle: _classes_cardTitle_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  }
});
                                          ...
                                          directives: [
                                            {
                                              ...
                                              value:
                                                ...
                                                _vm.is_teacher
                                                  ...
                                                  : false,
                                              expression:
                                                "meet.status == 'P' && is_teacher ? true : false"
                                            }
                                          ],
                ...
                _c("div", { staticClass: "table-responsive" }, [
                  _c("table", { staticClass: "table" }, [
                    ...
                    _vm.attendees.length > 0
                      ? _c(
                          "tbody",
                          _vm._l(_vm.attendees, function(attendee, key) {
                            return _c("tr", { key: key }, [
                              _c("td", [_vm._v(_vm._s(attendee.id))]),
                              _vm._v(" "),
                              _c("td", [
                                _vm._v(
                                  _vm._s(
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "modal-header" }, [
      _c(
        "h5",
        { staticClass: "modal-title", attrs: { id: "attendeeModalLabel" } },
        [
          _c("i", { staticClass: "material-icons" }, [_vm._v("people")]),
          _vm._v("  Meeting Participants\n          ")
        ]
      ),
      _vm._v(" "),
      _c(
  ...
  function() {
    ...
    return _c("thead", { staticClass: "text-primary" }, [
      _c("tr", [
        _c("th", [_vm._v("#")]),
        _vm._v(" "),
        _c("th", [_vm._v("Attendee")]),
        _vm._v(" "),
        _c("th", [_vm._v("Joined Time")])
      ])
    ])
  },
  function() {

  ...
  <div class="content">
    <div class="container-fluid">
        <div class="row" v-if="classes.length > 0">
            <div class="col-lg-4 col-md-6 col-sm-6" v-for="(clas, key) in classes" :key="key">
                <div class="card card-stats">
                    ...
                    <div class="card-footer">
                        ...
                        <router-link :to="{name: 'classlistView', params: { id: clas.id }}">{{ clas.class_lists.length }} students enrolled</router-link>
                        </div>
                    </div>
                </div>
            </div>

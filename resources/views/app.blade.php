...
<head>
    ...
    <link href="{{ asset('material') }}/summernote/summernote-bs4.min.css" rel="stylesheet" />
    <!-- CSS Files -->
...
<body class="{{ $class ?? '' }}">
    ...
    <script src="{{ asset('material') }}/summernote/summernote-bs4.min.js" type="text/javascript"></script>

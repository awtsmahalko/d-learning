...
<head>
    ...
    <link href="{{ $public }}/summernote/summernote-bs4.min.css" rel="stylesheet" />
    <!-- CSS Files -->
...
<body>
    ...
    <script src="{{ $public }}/summernote/summernote-bs4.min.js" type="text/javascript"></script>
    ...
    <script src="{{ $public }}/js/material-dashboard.js?v=2.1.1" type="text/javascript"></script>
    @stack('js')


    <script src="{{ $public }}/select2/js/select2.js" type="text/javascript"></script>
